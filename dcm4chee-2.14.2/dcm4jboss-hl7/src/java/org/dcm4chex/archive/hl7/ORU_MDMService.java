 ...
 * @since Dec 27, 2007
 */
public abstract class ORU_MDMService extends AbstractHL7Service {

    protected String xslPath;
    protected ObjectName exportManagerName;
    protected int storePriority;

    public final String getStylesheet() {
        return xslPath;
    }

    public final void setStylesheet(String path) {
        this.xslPath = path;
    }
    ...
    protected void storeSR(Dataset sr) throws Exception {
